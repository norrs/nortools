...
interface ChainResult { domain: string; zones: ZoneInfo[]; chainSecure: boolean; resolvers?: string[]; }
...
async function lookup() {
  ...
  try {
    result.value = await dnssecChain(domain.value, selectedResolver.value) as ChainResult;
  } catch (e: unknown) {
